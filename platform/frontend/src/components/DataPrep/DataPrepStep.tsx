...
import type { DirectoryInfo, PrepState } from '../../types'
...
export default function DataPrepStep({ onComplete }: Props) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8 space-y-8">
      <div>
        <h2 className="text-2xl font-bold text-white">Prepare Data</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-900 rounded-xl border border-slate-800 p-5 space-y-4">
          ...
          {dirInfo && (
            <div className="grid grid-cols-3 gap-3">
              <Stat label="Products" value={dirInfo.categories.length} />
        ...
        <div className="bg-slate-900 rounded-xl border border-slate-800 p-5 space-y-3">
          ...
          <DirectoryTree
            productDetails={dirInfo?.product_details ?? []}
